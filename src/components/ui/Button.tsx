...
const variants: Record<Variant, string> = {
  primary:
    "bg-brand-600 text-white shadow-[0_6px_16px_-6px_rgba(0,132,61,0.5)] hover:bg-brand-700",
  accent:
    "bg-accent-500 text-white shadow-[0_6px_16px_-6px_rgba(200,16,46,0.45)] hover:bg-accent-600",
  outline:
